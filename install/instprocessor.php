...
// generate new site_id and set manager theme to ClipperModern
if ($installMode == 0) {
    $siteid = uniqid('');
    mysql_query("REPLACE INTO $dbase.`" . $table_prefix . "system_settings` (setting_name,setting_value) VALUES('site_id','$siteid'),('manager_theme','ClipperModern')", $sqlParser->conn);
} else {
